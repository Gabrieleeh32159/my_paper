...
% ============================================================
\section{Metodología}
El pipeline experimental consta de cinco etapas: (1)~preprocesamiento de audio, (2)~extracción de \textit{features} a múltiples escalas,
...
El TSI articula el análisis diagnóstico de este trabajo y, a la vez, determina las estrategias de fusión guiadas por él. Para cada descriptor $f \in \{\text{MFCCs, Chroma, SC, SCon, SR, ZCR, Tonnetz}\}$ y escala $k \in \{s, m, l\}$, definimos primero la \textbf{ganancia de información normalizada}: \textcolor{red}{colocar cite}
